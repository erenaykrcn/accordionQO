...
# System setup
# -----------------------------
def get_BEC(N_vortices, N_iterations, co_rot=False, omega=400):
    bec = Gas(
            N_particles=2e5,
...
bec, psi_final = get_BEC(0, int(200), True)
...
def make_bilayer(psi1, psi2, seed=0):
