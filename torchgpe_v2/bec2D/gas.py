...
class Gas():
    ...
    def __init__(
        ...
        self.normalize_on_assignment = normalize_on_assignment
    ...
    @psi.setter
    def psi(self, value):
        value = value.to(device=self.device, dtype=self.complex_dtype)

        if self.normalize_on_assignment:
            value = normalize_wavefunction(value, self.dx, self.dy)
    ...
    def psik(self, value):
        ...
        if self.normalize_on_assignment:
            value = normalize_wavefunction(value, self.dkx, self.dky)
